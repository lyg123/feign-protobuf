package com.remcarpediem.feignprotobuf.common.dto;
...
public class LineReplyDTO implements Serializable {
    private List<DistributionReplyDTO> field1;
    ...
    public List<DistributionReplyDTO> getField1() {
        return field1;
    }

    public void setField1(List<DistributionReplyDTO> field1) {
        this.field1 = field1;
    }
