...
public class HeaderReplyDTO implements Serializable {
    private List<LineReplyDTO> field1;
    ...
    public List<LineReplyDTO> getField1() {
        return field1;
    }

    public void setField1(List<LineReplyDTO> field1) {
        this.field1 = field1;
    }
